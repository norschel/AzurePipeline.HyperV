function write-LogDebug($message)
{
    ...
    # These messages are only displayed when the system.debug variable is set to true.
...
{
    # Azure Pipelines supports title for section end
    Write-Output "##[endgroup]"
}
write-output "Imported PowerShell logging functions for Azure Pipelines"
